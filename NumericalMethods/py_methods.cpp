...
PyObject* half_division_test(PyObject*, PyObject* args)
{
    double r, c, left_edge, right_edge, epsilon;
...
PyObject* half_division_t(PyObject*, PyObject* args)
{
    double r, c, left_edge, right_edge, epsilon;
...
PyObject* simple_iteration(PyObject*, PyObject* args)
{
    ...
    while (fabs(x_j - x_i) > epsilon)
    {
        ...
        if (!((left_edge < x_j) && (x_j < right_edge)))
            return list;
        x_i = x_j;
        x_j = x_i - c * f(x_i);
    }
...
PyObject* simple_iteration_t(PyObject*, PyObject* args)
{
    double left_edge, right_edge, x_0, epsilon, c;
    if (!PyArg_ParseTuple(args, "ddddd", &left_edge, &right_edge, &epsilon, &x_0, &c))
    {
...
PyObject* simple_iteration_test(PyObject*, PyObject* args)
{
    double left_edge, right_edge, x_0, epsilon, c;
    if (!PyArg_ParseTuple(args, "ddddd", &left_edge, &right_edge, &epsilon, &x_0, &c))
    {
...
static PyMethodDef compile_methods[] = {
    ...
    { "half_division_t", (PyCFunction)half_division_t, METH_VARARGS, nullptr},
    { "simple_iteration_t", (PyCFunction)simple_iteration_t, METH_VARARGS, nullptr},
    { "half_division_test", (PyCFunction)half_division_test, METH_VARARGS, nullptr},
    { "simple_iteration_test", (PyCFunction)simple_iteration_test, METH_VARARGS, nullptr},
